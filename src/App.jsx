...
import { MdPlayArrow, MdPause, MdRefresh, MdArrowCircleDown, MdArrowCircleUp } from "react-icons/md";
    ...
    <div className="app">
      <div className="wrapper">
          ...
          <div className="length-control">
            ...
            <div>
              ...
              <button
                ...
                id="break-increment"
              >
                <MdArrowCircleUp className="icon" />
              </button>
            </div>
          </div>
          <div className="length-control">
        ...
        <div className="timer-wrapper">
          ...
          <h3 className={timeLeft < 60 ? "little-time-left" : ""} id="time-left">{timeFormatter()}</h3>
        </div>
        <div id="timer-control">
          <button onClick={handlePlay} className="icon-btn" id="start_stop">
             { play ? <MdPause className="icon" /> : <MdPlayArrow className="icon" /> } 
          </button>
